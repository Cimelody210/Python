...
def Main():
    ...
    while True:
        ...
        if luachon == 0:
            ...
            sv5 = DSSinhVien(2017463,"Nguyễn Tuấn Kiệt",datetime.strptime("20/11/2002","%d/%m/%Y"),79)
            sv6 = DSSinhVien(2118293,"Hoàng Minh Chiến",datetime.strptime("20/4/2003","%d/%m/%Y"),75)
            sv14 = DSSinhVien(2112115,"Vũ Thị Vân Anh",datetime.strptime("20/4/2003","%d/%m/%Y"),60)
            sv15 = DSSinhVien(2114789,"Nguyễn Châu Anh",datetime.strptime("20/4/2003","%d/%m/%Y"),50)
            sv12 = DSSinhVien(2110236,"Lý Cây Chanh",datetime.strptime("10/12/2003","%d/%m/%Y"),67)

            sv8 = DSSVPhiChinhQuy(2314862,"Nguyễn Văn A",datetime.strptime("1/1/2002","%d/%m/%Y"),"Cao Đẳng",2)
            sv9 = DSSVPhiChinhQuy(2318456,"Giulitano Tell",datetime.strptime("7/2/2001","%d/%m/%Y"),"Cử nhân",5)
            sv10 = DSSVPhiChinhQuy(1683843,"Trần Khánh Vy",datetime.strptime("21/8/1999","%d/%m/%Y"),"Cử nhân",5)
            sv11 = DSSVPhiChinhQuy(1818246,"Lê Tiến Linh",datetime.strptime("26/8/2000","%d/%m/%Y"),"Tiến sĩ",4)
